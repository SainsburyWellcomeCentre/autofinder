...
%
% pStack = boundingBoxesFromLastSection.groundTruth.genBordersForAllInDir(thresh)
%
% Purpose
...
for ii=1:length(D)
    ...
    pStack = boundingBoxesFromLastSection.groundTruth.genGroundTruthBorders(pStack,thresh);
