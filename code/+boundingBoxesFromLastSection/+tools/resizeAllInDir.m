function resizeAllInDir(runDir,targetMicsPix)
    ...
    %
    % function boundingBoxesFromLastSection.tools.resizeAllInDir(runDir,targetMicsPix)
    %
    % Purpose
    % Batch run of boundingBoxesFromLastSection.tools.resizePStack
    ...
    % Example
    % >> ls
    % >> boundingBoxesFromLastSection.tools.resizeAllInDir('stacks/twoBrains',20)
    %
    % Or run on all sub-directories:
    % >> boundingBoxesFromLastSection.tools.resizeAllInDir('stacks',20)
